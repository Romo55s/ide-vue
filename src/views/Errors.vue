<template>
<div class="bg-neutral-950 min-h-full flex justify-center items-center text-white flex-20 font-consolas">
  <div class="max-w-3xl p-8">
    <h1 class="text-4xl font-bold mb-4">Errors</h1>
    <div v-if="store.errors.length > 0">
      <table class="w-full table-auto">
        ...
        <tbody>
          <tr v-for="(token, index) in store.errors" :key="index" class="border-t border-green-400">
